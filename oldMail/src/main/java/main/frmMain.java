...
public class frmMain extends javax.swing.JFrame {
    ...
    public static String buzon[] = new String[N]; // Buzón para mensajes
    ...
    public class Emisor extends Thread {
        ...
        public void run() {
            while (true) {
                if(encendido){
                     mensaje = mensajes[this.elegirElemento()];
                    monitor.insertar(mensaje);
                    actualizarBuzon();
    ...
    public class Mensajero extends Thread {
     ...
     class super_monitor { // monitor como solución

        private int cuenta = 0, inf = 0, sup = 0;

        public synchronized void insertar(String val) {
            if (cuenta == N) {
